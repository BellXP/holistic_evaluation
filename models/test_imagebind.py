...
class TestImageBind:
    def __init__(self) -> None:
        ...
        self.model = llama.load("7B", llama_dir, knn=True, llama_type="7B_chinese", max_seq_len=1024, max_batch_size=1)
        self.model.eval()
    ...
    def batch_generate(self, image_list, question_list, max_new_tokens=128, temperature=0.1):
        results = self.model.generate(
            ...
            max_gen_len=max_new_tokens, temperature=temperature,
        )
        return results