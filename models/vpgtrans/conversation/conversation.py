...
class Chat:
    ...
    def batch_answer(self, image_list, question_list, chat_list, max_new_tokens=300, num_beams=5, min_length=1, top_p=0.9, repetition_penalty=1.0, length_penalty=1, temperature=1.0, max_length=2000, do_sample=True):
        embs_list = []
