...
class Chat:
    ...
    def batch_answer(self, batch_raw_img_list, batch_context, max_new_tokens=300, num_beams=1, min_length=1, top_p=0.9, repetition_penalty=1.0, length_penalty=1, temperature=1.0, max_length=2000, update_layer=16, do_sample=True):
        all_imgs = []
        ...
        conv_list = []
        for context, raw_img_list in zip(batch_context, batch_raw_img_list):
    ...
    def answer(self, raw_img_list, context, max_new_tokens=300, num_beams=1, min_length=1, top_p=0.9, repetition_penalty=1.0, length_penalty=1, temperature=1.0, max_length=2000, update_layer=16, do_sample=True):
        chat_state = CONV_VISION.copy()
        img_embd_list = []
        vit_list = []
        for i, text in enumerate(context.split("<Img><HereForImage></Img>")):
