        ...
        **generate_kwargs,
        ...
        if pixel_values is None:
            ...
            try:
                ...
                print(inputs_embeds[image_embeds_index].shape)
                print(language_model_inputs.reshape(-1,language_model_inputs.shape[-1]).shape)
                temp_inputs = language_model_inputs.reshape(-1,language_model_inputs.shape[-1])
                temp_inputs = temp_inputs[:len(inputs_embeds[image_embeds_index])]
                inputs_embeds[image_embeds_index] = temp_inputs
